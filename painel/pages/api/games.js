...
// 🔹 Config real do Firebase (a mesma usada no painel)
  ...
  try {
    ...
    for (const docSnap of snapshot.docs) {
      ...
      games.push({
        ...
        start_time: g.time,
        end_time: null,        // calcularemos depois
        is_live: null,         // calcularemos depois
        is_finished: null,     // calcularemos depois
        buttons: g.channels || []
      });
    }
...
// Helpers para buscar logos no Firestore
